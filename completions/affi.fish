...
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a root-cause          -d 'Trace root cause of failure'
...
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a coverage-analysis   -d 'Event coverage completeness'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a tech-debt           -d 'Technical debt analysis'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a security-debt       -d 'Security vulnerability analysis'
# Ingestion
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-batch          -d 'Bulk-emit events from JSON array file'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-cicd      -d 'Emit from CI/CD pipeline'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-cloud     -d 'Emit from cloud events'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-github    -d 'Emit from GitHub webhook'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-gitlab    -d 'Emit from GitLab webhook'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-monitoring -d 'Emit from monitoring alerts'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-sbom      -d 'Emit from SBOM components'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a emit-from-security  -d 'Emit from security scan results'
# Compliance
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a verify-compliance   -d 'Verify against compliance framework'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a verify-sla          -d 'Verify against SLA targets'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a verify-family       -d 'Verify multiple receipts for consistency'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a policy-enforce      -d 'Enforce custom policy rules'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a license-compliance  -d 'License compliance check'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a gdpr-proof          -d 'GDPR evidence generation'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a hipaa               -d 'HIPAA compliance check'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a pci-dss             -d 'PCI-DSS compliance check'
# Attestation
...
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a assemble-with-signature -d 'Assemble and sign in one step'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a assemble-and-notarize   -d 'Assemble and notarize in one step'
# SBOM
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a sbom-attest         -d 'Attest SBOM provenance'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a sbom-scan           -d 'Scan SBOM for vulnerabilities'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a sbom-blast-radius   -d 'SBOM dependency blast radius'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a sbom-compliance     -d 'SBOM compliance check'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a sbom-ntia           -d 'NTIA minimum elements check'
# Insights
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a anomaly-detect      -d 'Detect anomalous events'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a predict             -d 'Predict future events'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a trend-analysis      -d 'Analyze event trends over time'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a variance            -d 'Variance analysis across receipts'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a find-blast-radius   -d 'Find dependency blast radius'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a explain-incident    -d 'Explain incident from receipt chain'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a causality-chain     -d 'Build causality chain'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a bus-factor          -d 'Bus factor analysis'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a dora-metrics        -d 'DORA metrics from receipt chain'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a team-velocity       -d 'Team velocity from events'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a portfolio-health    -d 'Portfolio health across receipts'
# Engineering
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a orphaned-code       -d 'Find orphaned code events'
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a dependency-matrix   -d 'Build dependency matrix'
...
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a install-git-hook    -d 'Install git hook for auto-verify'
...
complete -c affi -f -n '__affi_using_noun receipt; and __affi_no_verb' -a receipt-throughput  -d 'Throughput benchmark'
